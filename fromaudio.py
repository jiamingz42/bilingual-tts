...
def create_audio_from_audio(input_audio, subtitle_file, output_file, transition_sound, repeat_count, tr_lang, verbose, tr_strategy='deepl'):
    translate_func = deepl.translate_text if tr_strategy == 'deepl' else fake_translate_func
...
def fromaudio_main(args):
    create_audio_from_audio(args.input_audio, args.subtitle_file, args.output_file, args.transition_sound, args.repeat_count, args.tr_lang, args.verbose, args.tr_strategy)
